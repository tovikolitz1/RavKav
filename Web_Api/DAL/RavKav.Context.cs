...
namespace DAL
{
    ...
    public partial class RavKavEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> sp_addUder_Insert(string fName, string lName, string email, string pass, string ravkavNum, Nullable<int> profileId)
        {
            ...
            var ravkavNumParameter = ravkavNum != null ?
                new ObjectParameter("ravkavNum", ravkavNum) :
                new ObjectParameter("ravkavNum", typeof(string));
    
            var profileIdParameter = profileId.HasValue ?
                new ObjectParameter("profileId", profileId) :
                new ObjectParameter("profileId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("sp_addUder_Insert", fNameParameter, lNameParameter, emailParameter, passParameter, ravkavNumParameter, profileIdParameter);
        }
